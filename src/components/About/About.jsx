  ...
  return (
    ...
    >
      <div className="max-w-xl text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#8245ec]">
          Manyatha M
        </h2>
        <p className="text-lg md:text-xl mb-4">
          ...
          platform, showcase my ability to design robust authentication systems,
          role-based access, and real-time order management. I’m skilled in
          JavaScript, C, C++, Python, React, Node.js, Express, MongoDB, and
          PostgreSQL, with hands-on experience in developing REST APIs and
